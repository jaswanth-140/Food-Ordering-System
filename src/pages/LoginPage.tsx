      ...
      <div className="flex flex-col justify-center w-full lg:w-[45%] px-8 sm:px-16 lg:px-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 max-w-sm">
          ...
          <button
            ...
            className="w-full py-3.5 px-4 bg-background border border-glass-border hover:bg-glass rounded-xl flex items-center justify-center gap-3 transition-colors text-foreground font-medium"
          >
